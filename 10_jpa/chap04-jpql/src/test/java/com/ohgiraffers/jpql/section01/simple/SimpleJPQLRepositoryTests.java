...
public class SimpleJPQLRepositoryTests {
    ...
    @DisplayName("TypeQuery를 이용한 단일행, 단일컬럼 조회")
    @Test
    ...
    @DisplayName("TypeQuery를 이용한 다중행, 다중행 조회")
    @Test
    ...
    @DisplayName("DISTINCT 연산자 사용 조회")
    @Test
