 ...
 * 숫자(number), 문자열(string), 블린(boolean), null, undefined 등이 있다.
 */
...
// 불린(Boolean): 논리적 참, 거짓을 나타내는 true와 false 뿐이다.
var isStudent = true;
...
// 자바스트립트의 첫 번째 버전의 버그 (null이 아닌 object로 출력)
...
console.log('제 이름은 ${lastName}${firstName}입니다.'); // 문자열로 인식해서 출력된다-> 제 이름은 ${lastName}${firstName}입니다. 
