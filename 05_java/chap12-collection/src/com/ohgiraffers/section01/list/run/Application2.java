...
public class Application2 {
    public static void main(String[] args) {
        ...
        bookList.add(new BookDTO(3, "삼국사기", "김부식", 8000));
        bookList.add(new BookDTO(2, "동의보감", "허준", 3000));
        ...
        * Collections.sort()메소드는 별도의 정렬 기준을 주지 않으면, 이 기본 정렬 기준을 사용한다. */
        ...
        /* 익명 클래스 사용 -> 1회용으로 클래스를 별도로 만들지 않고 바로 사용할 때 (가격 내림차순) */
        ...
        /* 람다식 사용 (제목 오름차순) */
        /* 인터페이스에 메소드가 하난만 있는 경우,
        *  익명 클래스 대신 람다식을 사용하여 훨씬 간결하게 코드를 작성할 수 있다.
        *  .compareTo 문자열 비교 메소드
        *  매개변수, 매개변수 ->(람다표현식) b1.getTitle().compareTo(b2.getTitle()
        * */
